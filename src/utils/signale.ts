...
const basicLog = {
  ...
  messageDump: (props: any, payload: any) => signale.success(`Message Received\r\n${props}\r\nPayload\r\n${payload}`),
  ctrlDToPublish: () => signale.success('Connected, press Ctrl+D to publish, press Ctrl+C to exit'),
